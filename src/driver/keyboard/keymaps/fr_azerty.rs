...
pub const FR_AZERTY_KEYMAP: Keymap = {
    ...
    keymap[ScanCodeValue::One as usize] = Some(KeymapSet {
        ...
        shift: KeymapValue::Ascii('1'),
        alt1: KeymapValue::Alt('&'),
        alt2: KeymapValue::Alt('&'),
        alt_shift: KeymapValue::Alt('1'),
        ctrl: KeymapValue::Control('@'),
    });
    keymap[ScanCodeValue::Two as usize] = Some(KeymapSet {
        // é
        not_shift: KeymapValue::Ascii('e'),
        shift: KeymapValue::Ascii('2'),
        alt1: KeymapValue::Alt('e'),
        alt2: KeymapValue::Alt('~'),
        alt_shift: KeymapValue::Alt('2'),
        ctrl: KeymapValue::Control('@'),
    });
    keymap[ScanCodeValue::Three as usize] = Some(KeymapSet {
        not_shift: KeymapValue::Ascii('"'),
        shift: KeymapValue::Ascii('3'),
        alt1: KeymapValue::Alt('"'),
        alt2: KeymapValue::Alt('#'),
        alt_shift: KeymapValue::Alt('3'),
        ctrl: KeymapValue::Control('@'),
    });
    keymap[ScanCodeValue::Four as usize] = Some(KeymapSet {
        not_shift: KeymapValue::Ascii('\''),
        shift: KeymapValue::Ascii('4'),
        alt1: KeymapValue::Alt('\''),
        alt2: KeymapValue::Alt('{'),
        alt_shift: KeymapValue::Alt('4'),
        ctrl: KeymapValue::Control('@'),
    });
    keymap[ScanCodeValue::Five as usize] = Some(KeymapSet {
        not_shift: KeymapValue::Ascii('('),
        shift: KeymapValue::Ascii('5'),
        alt1: KeymapValue::Alt('('),
        alt2: KeymapValue::Alt('['),
        alt_shift: KeymapValue::Alt('5'),
        ctrl: KeymapValue::Control('@'),
    });
    keymap[ScanCodeValue::Six as usize] = Some(KeymapSet {
        not_shift: KeymapValue::Ascii('-'),
        shift: KeymapValue::Ascii('6'),
        alt1: KeymapValue::Alt('-'),
        alt2: KeymapValue::Alt('|'),
        alt_shift: KeymapValue::Alt('6'),
        ctrl: KeymapValue::Control('@'),
    });
    keymap[ScanCodeValue::Seven as usize] = Some(KeymapSet {
        // è
        not_shift: KeymapValue::Ascii('e'),
        shift: KeymapValue::Ascii('7'),
        alt1: KeymapValue::Alt('e'),
        alt2: KeymapValue::Alt('`'),
        alt_shift: KeymapValue::Alt('7'),
        ctrl: KeymapValue::Control('@'),
    });
    keymap[ScanCodeValue::Eight as usize] = Some(KeymapSet {
        not_shift: KeymapValue::Ascii('_'),
        shift: KeymapValue::Ascii('8'),
        alt1: KeymapValue::Alt('_'),
        alt2: KeymapValue::Alt('\\'),
        alt_shift: KeymapValue::Alt('8'),
        ctrl: KeymapValue::Control('@'),
    });
    keymap[ScanCodeValue::Nine as usize] = Some(KeymapSet {
        // ç
        not_shift: KeymapValue::Ascii('c'),
        shift: KeymapValue::Ascii('9'),
        alt1: KeymapValue::Alt('c'),
        alt2: KeymapValue::Alt('^'),
        alt_shift: KeymapValue::Alt('9'),
        ctrl: KeymapValue::Control('@'),
    });
    keymap[ScanCodeValue::Zero as usize] = Some(KeymapSet {
        // à
        not_shift: KeymapValue::Ascii('a'),
        shift: KeymapValue::Ascii('0'),
        alt1: KeymapValue::Alt('a'),
        alt2: KeymapValue::Alt('@'),
        alt_shift: KeymapValue::Alt('0'),
        ctrl: KeymapValue::Control('@'),
    });
    keymap[ScanCodeValue::Min as usize] = Some(KeymapSet {
        // shift is ° on a real keyboard -> ASCII fallback ')'
        not_shift: KeymapValue::Ascii(')'),
    ...
    keymap[ScanCodeValue::BackTick as usize] = None;
