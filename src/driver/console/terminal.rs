    ...
    driver::{
        console::{
            ansi::{
                ...
                BG_BRIGHT_YELLOW, BG_CYAN, BG_GREEN, BG_MAGENTA, BG_RED, BG_RESET, BG_WHITE,
                BG_YELLOW, FG_BLACK, FG_BLUE, FG_BRIGHT_BLACK, FG_BRIGHT_BLUE, FG_BRIGHT_CYAN,
                FG_BRIGHT_GREEN, FG_BRIGHT_MAGENTA, FG_BRIGHT_RED, FG_BRIGHT_WHITE,
                FG_BRIGHT_YELLOW, FG_CYAN, FG_GREEN, FG_MAGENTA, FG_RED, FG_RESET, FG_WHITE,
                FG_YELLOW, RESET,
            },
            history::History,
        },
    ...
    pub fn handle_keyboard_input(&mut self, byte: u8) {
        match byte {
            b'\n' | b'\r' => {
                ...
                shell::add_line_to_buf(self.id, input);
